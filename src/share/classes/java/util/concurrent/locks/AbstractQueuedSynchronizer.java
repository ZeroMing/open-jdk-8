...
public abstract class AbstractQueuedSynchronizer
     ...
     * CANCELLED.
     * 等待队列的头，惰性初始化。除了初始化，只可以通过setHead方法修改。
     * 注意: 如果存在head，则保证它的等待状态不为【取消状态】。
     */
     ...
     * 等待队列的尾，惰性初始化。通过添加新的等待节点来修改尾节点的值
     */
    ...
    private void unparkSuccessor(Node node) {
        ...
        // 获取head节点的状态如果状态不是初始状态或cancelled，则设置为初始
        if (ws < 0) {
         ...
         * 如果后继节点为空或者而被取消状态。从尾节点反向查找，直到找到后继节点。
         */
        Node s = node.next;
    ...
    final boolean acquireQueued(final Node node, int arg) {
        ...
        try {
            ...
            for (;;) {
                ...
                // 只有前驱节点为头节点，才会去尝试获取锁，获取成功，进行相关操作
